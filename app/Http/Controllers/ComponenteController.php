    ...
    function add(Request $dados)
    {
        $validator = Validator::make(
            ...
            [
                ...
                'hora_inicio.date' => 'Informe uma data e hora válida para o início.',

                'hora_fim.required' => 'O campo hora fim é obrigatório.',
                'hora_fim.date' => 'Informe uma data e hora válida para o fim.',
                'hora_fim.after' => 'A hora fim deve ser posterior à hora início.',
            ]
        );
